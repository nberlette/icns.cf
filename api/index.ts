...
<head>
    ...
    <meta charSet="utf-8" />
    <meta name="title" content="icns.ml - SimpleIcons as a Service" />
    <meta name="description"
      content="Providing 2100+ SVG icons from SimpleIcons, a dynamic colors API, and deployed globally on Vercel's Edge Network. 100% open source software." />
    <meta name="keywords"
      content="icns,icns.ml,icns.cf,simpleicons,svg,icons,vector,nberlette,berlette,api,vercel,open-source,edge,cdn,graphic design,graphics,ui,ux,iconography,free,endpoint" />
    <meta name="twitter:site" content="@nberlette" />
    <meta name="twitter:user_id" content="@nberlette" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:image" content="/og.png" />
    <meta name="twitter:image:src" content="/og.png" />
    <meta name="twitter:title" content="icns.ml" />
    <meta name="twitter:description" content="SimpleIcons as a Service" />
    <meta name="twitter:url" content="https://icns.ml/?utm_source=twitter" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="icns.ml" />
    <meta property="og:description" content="SimpleIcons as a Service" />
    <meta property="og:image" content="/og.png" />
    <meta property="og:url" content="https://icns.ml/?utm_source=opengraph" />
    <meta name="author" content="Nicholas Berlette" />
    <meta name="canonical" property="canonical" content="https://icns.ml/" />
    <link rel="canonical" href="https://icns.ml/" type="canonical" />
    <link rel="apple-touch-icon" href="/apple-touch-icon.png" type="image/png" purpose="apple-touch-icon any"
      sizes="180x180" />
    <link rel="icon" href="/favicon.svg" type="image/svg+xml" purpose="maskable any" />
    ...
    <style type="text/css">
      :root {
        ...
        --icns-github-corner-fill: #234;
        --icns-github-corner-color: #fff;
      }
      ...
      @media screen and (prefers-color-scheme: dark) {
        :root {
          ...
          --icns-github-corner-fill: #e7f0f0;
          --icns-github-corner-color: #223344;
        }
      }
...
<body>
<a href="https://github.com/nberlette/icns" class="github-corner" aria-label="View Source on GitHub">
...
<header align=center>
  <h1>
    <a href="/" title="icns.ml - SimpleIcons as a Service" aria-label="icns.ml - SimpleIcons as a Service">
  ...
  <p>
    <h3>2100+ SVG Icons <a href="https://simpleicons.org" target="_blank" rel="noopener noreferrer"><img src="/simpleicons.svg" alt="SimpleIcons" width="32" /></a> &middot; Dynamic Color API &middot; Global Edge CDN with <a href="https://vercel.com" target="_blank" rel="noopener noreferrer"><img src="/vercel.svg" alt="Vercel" width="32" /></a></h3>
  </p>
</header>
...
<pre class="zi-dark">https://icns.ml/ :name [-:color] [.:type]</pre>
<pre class="zi-dark">https://icns.ml/ [:color] / :name [.:type]</pre>
