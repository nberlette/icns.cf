...
[MIT](https://mit-license.org) © ${new Date().getFullYear()} [@nberlette](https://github.com/nberlette/icns) • icons by [SimpleIcons](https://simpleicons.org)
